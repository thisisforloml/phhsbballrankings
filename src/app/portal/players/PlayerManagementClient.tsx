      ...
      <div className="grid lg:grid-cols-[17rem_1fr]">
        <aside className="bg-navy-800 px-5 py-8 text-white lg:min-h-[calc(100vh-5rem)]">
          ...
          <nav className="mt-8 grid gap-2 font-semibold">
            <a href="/portal" className="rounded-md px-3 py-2 hover:bg-white/10">Dashboard</a>
            <a href="/portal/live-stats" className="rounded-md px-3 py-2 hover:bg-white/10">Live Stats Entry</a>
            <a href="/portal/players" className="rounded-md bg-white/10 px-3 py-2 text-amber-300">Players</a>
          </nav>
        </aside>
