...
const homeSectionHeadingClass =
  "mt-1.5 font-display text-2xl font-bold tracking-tight text-white max-md:normal-case md:mt-2 md:uppercase";
  ...
  return (
    <PublicPageShell variant="scout" className="pt-0">
      ...
      {data.boardMovers.length ? (
        <section className="container-px py-5 md:py-10">
      ...
      <section className="container-px pb-5 md:pb-10">
        <div className="mx-auto max-w-[74rem]">
          {data.boardMovers.length ? (
            <div className="mb-5 flex justify-center md:mb-8" aria-hidden="true">
          ...
          <div className="mb-5 grid grid-cols-1 gap-4 lg:grid-cols-3 lg:items-end">
            ...
            <div className="flex items-end justify-between gap-3 lg:col-span-1">
              <div>
                ...
                <h2 className={homeSectionHeadingClass}>U19 National</h2>
              </div>
...
function HomeTeamModule({ data }: { data: HomeData }) {
  ...
  return (
    <section className="container-px border-t border-white/[0.06] py-5 md:py-10">
      <div className="mx-auto max-w-[74rem]">
        ...
        <div className="mb-2 flex flex-wrap items-end justify-between gap-3">
          <div>
            ...
            <h2 className={homeSectionHeadingClass}>Team Standings Snapshot</h2>
          </div>
          <Link
            href="/teams"
            className={homeSectionLinkClass}
        ...
        <article className="mt-5 overflow-hidden rounded-sm border border-white/[0.08] bg-scout-800/80">
          ...
          {data.teamPreview.map((team, index) => (
            <Link
              ...
              className="home-mobile-tap-list grid grid-cols-[3rem_1fr_7rem_5rem] items-center gap-2 border-b border-white/[0.06] px-3 py-2 transition-colors duration-200 last:border-b-0 hover:bg-court-800"
            >
