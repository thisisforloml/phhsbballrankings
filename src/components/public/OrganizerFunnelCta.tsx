    ...
    <section className="container-px border-y border-line-500 bg-court-900 py-8 text-white">
      <div className="mx-auto flex max-w-[74rem] flex-col gap-5 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link href="/admin/submissions" onClick={() => capturePublicEvent("submit_stats_clicked", { destination: "admin-submissions" })} className="rounded-sm border border-hardwood-600 bg-hardwood-600 px-4 py-3 text-sm font-bold uppercase tracking-[0.04em] text-white hover:border-hardwood-700 hover:bg-hardwood-700">
            Submit stats
          </Link>
        </div>
      </div>
