 ...
 * =============================================================================
 *
 * Archived UAAP Season 88 batch GameStat import (historical reference only).
 *
 * Purpose: One-time load of GameStat rows from eight UAAP S88 HS batch JSON files.
 * Historical usage: Initial UAAP Season 88 database bootstrap (completed).
 ...
 * can corrupt historical evidence. See scripts/archive/uaap-s88/README.md.
 */
...
/** Run from repository root: tsx scripts/archive/uaap-s88/import-game-stats-from-batches.ts */
